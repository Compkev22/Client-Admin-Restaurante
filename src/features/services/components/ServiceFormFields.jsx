  ...
  <div className="grid grid-cols-1 gap-4">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      <div className="flex flex-col gap-1">
        ...
        />
        {errors.AdditionalPrice && <p className="text-red-600 text-xs font-bold">{errors.AdditionalPrice.message}</p>}
      </div>
      <div className="flex flex-col gap-1">
        <label className="text-xs font-black text-gray-500 uppercase tracking-widest">Estado</label>
        <select
