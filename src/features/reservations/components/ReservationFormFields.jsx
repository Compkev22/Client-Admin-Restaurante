    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-gray-50 p-5 rounded-2xl border border-gray-100">
        <div className="flex flex-col gap-1">
          ...
          <select {...register("branchId", { required: "Obligatorio" })} className="w-full px-4 py-3 rounded-xl border-2 border-gray-100 focus:border-kinal-red outline-none bg-white font-bold">
        ...
        <div className="flex flex-col gap-1">
          ...
          <select {...register("clientId", { required: "Obligatorio" })} className="w-full px-4 py-3 rounded-xl border-2 border-gray-100 focus:border-kinal-red outline-none bg-white font-bold">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        <div className="flex flex-col gap-1">
          ...
          <input type="date" min={todayISO} {...register("date", { required: "Selecciona una fecha" })} className={`w-full px-4 py-3 rounded-xl border-2 outline-none font-bold ${errors.date ? "border-red-500" : "border-gray-100 focus:border-kinal-red"}`} />
        ...
        <div className="flex flex-col gap-1">
          ...
          <input type="time" {...register("time", { required: "Selecciona la hora" })} className={`w-full px-4 py-3 rounded-xl border-2 outline-none font-bold ${errors.time ? "border-red-500" : "border-gray-100 focus:border-kinal-red"}`} />
        ...
        <div className="flex flex-col gap-1">
          ...
          <input type="number" {...register("numberOfPersons", { required: "Ingresa la cantidad", min: { value: 1, message: "Mínimo 1" }, max: { value: 50, message: "Máximo 50" } })} className={`w-full px-4 py-3 rounded-xl border-2 outline-none font-bold ${errors.numberOfPersons ? "border-red-500" : "border-gray-100 focus:border-kinal-red"}`} />
      ...
      <div className="flex flex-col gap-1">
        ...
        <textarea {...register("notes")} rows="2" className="w-full px-4 py-3 rounded-xl border-2 border-gray-100 focus:border-kinal-red outline-none resize-none font-medium" />
      </div>
