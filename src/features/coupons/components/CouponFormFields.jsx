    ...
    <div className="grid grid-cols-1 gap-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="flex flex-col">
          ...
          <input
            type="number"
            {...register("discountPercentage", { required: "El descuento es obligatorio", min: { value: 1, message: "Mínimo 1%" }, max: { value: 100, message: "Máximo 100%" } })}
        ...
        <div className="flex flex-col">
          ...
          <input
            type="number"
            {...register("usageLimit", { required: "El límite de uso es obligatorio", min: { value: 1, message: "Mínimo 1" } })}
            className="w-full px-4 py-3 rounded-xl border-2 border-gray-100 focus:border-kinal-red outline-none font-bold"
          />
          {errors.usageLimit && <p className="text-red-500 text-[10px] mt-1 font-bold">{errors.usageLimit.message}</p>}
        </div>
      </div>
