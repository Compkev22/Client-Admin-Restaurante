...
export const TableFormFields = ({ register, errors, branches }) => (
  <div className="space-y-5">
    ...
    <div className="flex flex-col gap-1">
      <label className="text-xs font-black text-gray-500 uppercase tracking-widest">Sucursal</label>
      <select
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      <div className="flex flex-col gap-1">
        <label className="text-xs font-black text-gray-500 uppercase tracking-widest">Número de Mesa</label>
        <input
          type="number"
      ...
      <div className="flex flex-col gap-1">
        <label className="text-xs font-black text-gray-500 uppercase tracking-widest">Capacidad (Personas)</label>
        <input
          type="number"
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-orange-50 p-4 md:p-5 rounded-2xl border border-orange-100">
      <div className="flex flex-col gap-1">
        <label className="text-xs font-black text-gray-500 uppercase tracking-widest">Disponibilidad Actual</label>
        <select
      ...
      <div className="flex flex-col gap-1">
        <label className="text-xs font-black text-gray-500 uppercase tracking-widest">Estado del Registro</label>
        <select
