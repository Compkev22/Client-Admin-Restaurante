        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex flex-col gap-1">
                ...
                <input
                    ...
                    className={`w-full px-4 py-2 rounded-xl border ${errors.Email ? 'border-red-500' : 'border-gray-200'}`}
                />
            ...
            <div className="flex flex-col gap-1">
                ...
                <input
                    ...
                    {...register("phone", {
                        required: "Requerido",
                        pattern: { value: /^[0-9]{8}$/, message: "Número de teléfono inválido" }
                    })}
                    className="w-full px-4 py-2 rounded-xl border border-gray-200 focus:ring-2 focus:ring-kinal-orange outline-none"
                />
